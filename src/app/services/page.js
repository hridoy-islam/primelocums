      ...
      <div className="my-10">
        <div className="space-y-6">
          <p>
            ...
            medical solutions we are capable of developing and adapting a
            variety of services to meet the individual requirements of our
            clients. For each client a bespoke solution ensures that maximum
            savings and effectiveness can be achieved. We understand that each
            solution must be in the best interests of the client and offer our
            clients expert knowledge and current market advice. In order to
            provide a best quality, best price solution we offer a vast array of
            service solutions that can be tailored to individual client needs.
          </p>
        </div>

        <div className="my-10 grid xs:grid-cols-1 md:grid-cols-2 gap-4">
