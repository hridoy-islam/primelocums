  ...
  return (
    <section className="py-16">
      ...
      <p>
        ...
        with more than 800 staff and a turnover in excess of £500 million,
        Hamilton Bradshaw is one of the world’s top 50 recruitment companies.
        DRC Locums has established itself as one of the leading and most
        innovative providers of medical staffing solutions across the UK to both
        the Public and Private Sector. Working with us you will receive training
        from some of the industry’s leading recruiters and you will be set for
        success from day one. Have you got passion, drive, good communication
        skills and a positive outlook? If so, we want to hear from you. We are
        currently expanding the company and are therefore recruiting people for
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <p class="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
              ...
              our team on 01908 545 999 for a confidential chat and see how we
              can help you in the next step of your career. Alternatively send
              us a copy of your up to date CV by filling in the form below.
            </p>
          </div>
        </div>
