    ...
    <section className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <ServiceCard
            title="Integrity"
            details="We operate with transparency and ethical practices, ensuring full legal compliance with NHS guidelines and UK recruitment laws."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            title="Commitment"
            details="We are committed to the long-term success of both healthcare providers and workers, fostering a supportive and reliable partnership."
            icon={
              <svg
                width="36"
                height="36"
